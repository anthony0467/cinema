...
-- Listage des données de la table cinema_anthony.casting : ~33 rows (environ)
...
-- Listage des données de la table cinema_anthony.categoriser : ~25 rows (environ)
...
CREATE TABLE IF NOT EXISTS `film` (
  ...
  `titre` varchar(60) COLLATE utf8mb3_bin NOT NULL,
  `annee_sortie_film` int NOT NULL,
  `synopsis` longtext COLLATE utf8mb3_bin,
  `duree_minute` int NOT NULL,
  `note` int DEFAULT NULL,
  `affiche` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `personne` (
  ...
  `sexe` varchar(50) COLLATE utf8mb3_bin NOT NULL,
  `date_naissance` date NOT NULL,
  `photo` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `role` (
  ...
  `nom_role` varchar(20) COLLATE utf8mb3_bin DEFAULT NULL,
  PRIMARY KEY (`id_role`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;

-- Listage des données de la table cinema_anthony.role : ~11 rows (environ)
