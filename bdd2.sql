...
-- Listage des données de la table cinema_anthony.acteur : ~9 rows (environ)
...
INSERT INTO `film` (`id_film`, `titre`, `annee_sortie_film`, `synopsis`, `duree_minute`, `note`, `affiche`, `id_realisateur`) VALUES
	...
	(10, 'Le hobbit - la bataille des cinq armées', 2014, 'Atteignant enfin la Montagne Solitaire, Thorin et les Nains, aidés par Bilbon le Hobbit, ont réussi à récupérer leur royaume et leur trésor. Ils ont également réveillé le dragon Smaug qui déchaîne désormais sa colère sur les habitants de Lac-ville. À présent, les Nains, les Elfes, les Humains mais aussi les Wrags et les Orques menés par le Nécromancien, convoitent les richesses de la Montagne Solitaire.', 144, 4, 'https://fr.web.img3.acsta.net/pictures/14/11/14/17/43/568445.jpg', 1),
	(11, 'Man of steel', 2013, 'Lorsque Jor-El comprend que sa planète, Krypton, est au bord de l\'annihilation, il décide d\'envoyer son fils unique, Kal-El, sur la planète Terre dans le but de sauver sa race. Kal-El est recueilli par des fermiers qui le nomment Clark et lui apprennent à cacher ses pouvoirs surnaturels pour éviter d\'effrayer les Terriens. Clark grandit et finit par découvrir ses origines.', 143, 2, 'https://fr.web.img3.acsta.net/pictures/210/081/21008110_20130524125237634.jpg', 3),
	(12, 'Danse avec les loups', 1991, 'Dans un avant-poste de l\'Ouest américain, la vie d\'un soldat est transformée au contact d\'une tribu indienne.', 181, 5, 'https://fr.web.img5.acsta.net/medias/nmedia/18/83/23/81/19672460.jpg', 4),
